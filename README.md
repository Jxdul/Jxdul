...
- I build serverless apps, admin dashboards, and automation tools for real operations
- I work with storefronts, Discord workflows, image processing, payments, and kiosk hardware
- I like connecting APIs, databases, hardware, and clean interfaces into useful systems
